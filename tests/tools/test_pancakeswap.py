"""Tests for PancakeSwap V3 quote, swap, and liquidity tools."""
...
class TestPancakeSwapAddLiquidity:
    ...
    async def test_token_ordering(self):
        ...
        with (
            ...
            patch(
                "intentkit.tools.base.IntentKitTool.save_agent_tool_data",
                new=AsyncMock(),
            ),
        ):
            result = await tool._arun(
...
class TestPancakeSwapRemoveLiquidity:
    ...
    async def test_full_removal_with_burn(self):
        ...
        tool = PancakeSwapRemoveLiquidity()
        ctx = _mock_context()
        wallet = _mock_wallet()
    ...
    async def test_staked_auto_unstake(self):
        ...
        with (
            ...
            patch(
                "intentkit.tools.base.IntentKitTool.delete_agent_tool_data",
                new=AsyncMock(),
            ),
        ):
            result = await tool._arun(
