"""Tool for calling another agent."""
...
class CallAgentTool(SystemTool):
    """Tool for calling another agent and getting its response.

    This tool allows an agent to delegate tasks to other agents
    ...
    async def _arun(
        ...
        try:
            ...
            # For other message types (tool, etc.), raise an exception
            raise ToolException(
