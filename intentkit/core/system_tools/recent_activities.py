"""Tool for retrieving agent's recent activities."""
...
class RecentActivitiesTool(SystemTool):
    """Tool for retrieving the agent's recent activities.

    This tool allows an agent to retrieve its own recent activities,
