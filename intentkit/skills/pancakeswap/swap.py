"""PancakeSwap V3 swap skill — execute a token swap via SmartRouter."""
...
class PancakeSwapSwap(PancakeSwapBaseTool):
    ...
    args_schema: ArgsSchema | None = PancakeSwapSwapInput
    ...
    async def _arun(
        ...
        **kwargs: Any,
        ...
        try:
            ...
            router_address = SMART_ROUTER_ADDRESSES.get(chain_id)
