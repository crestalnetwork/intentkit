"""
Utility functions for web scraper tools.

This module contains common functionality used across all web scraper tools
...
class VectorStoreManager:
    ...
    async def get_existing_vector_store(self, agent_id: str) -> dict[str, Any] | None:
        ...
        return await AgentToolData.get(agent_id, "web_scraper", vector_store_key)
    ...
    async def save_vector_store(
        ...
        """Save vector store to agent tool data."""
        vector_store_key, _ = self.get_storage_keys(agent_id)
...
class MetadataManager:
    ...
    async def get_existing_metadata(self, agent_id: str) -> dict[str, Any]:
        ...
        return await AgentToolData.get(agent_id, "web_scraper", metadata_key) or {}
...
class ResponseFormatter:
    """Formats consistent responses for web scraper tools."""
