"""Utilities for fastCRW tool content indexing and querying."""
...
class CrwDocumentProcessor:
    """Handles document processing and sanitization for fastCRW content."""
    ...
    def split_documents(
        ...
        for doc in documents:
            ...
            sanitized_content = CrwDocumentProcessor.sanitize_for_database(
                doc.page_content
            )
...
class CrwVectorStoreManager:
    """Manages vector store operations for fastCRW content."""
    ...
    async def load_vector_store(self, agent_id: str) -> FAISS | None:
        ...
        try:
            ...
            stored_data = await AgentToolData.get(
...
class CrwMetadataManager:
    """Manages metadata for fastCRW indexed content."""
...
async def index_documents(
    ...
    """
    Index documents into the fastCRW vector store.
...
async def query_indexed_content(
    ...
    """
    Query the fastCRW indexed content.
