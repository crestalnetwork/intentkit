...
from intentkit.tools.dexscreener.model.search_token_response import PairModel
from intentkit.tools.dexscreener.utils import (
    API_ENDPOINTS,
    RATE_LIMITS,
...
class GetPairInfo(DexScreenerBaseTool):
    ...
    async def _arun(
        ...
        **kwargs: Any,
        ...
        # Apply rate limiting
        await self.global_rate_limit_by_tool(
