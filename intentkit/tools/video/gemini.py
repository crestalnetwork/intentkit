"""Google Veo video generation tools."""
...
from intentkit.tools.video.base import MAX_POLL_TIME, POLL_INTERVAL, VideoBaseTool

logger = logging.getLogger(__name__)


class VeoVideoBase(VideoBaseTool):
    """Base class for Google Veo video generation tools."""
