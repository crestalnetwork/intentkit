...
from intentkit.tools.opensea.base import OpenSeaApiMixin
from intentkit.tools.opensea.constants import (
    ERC721_APPROVAL_ABI,
    ITEM_TYPE_ERC721,
    ITEM_TYPE_NATIVE,
    NETWORK_TO_CHAIN,
...
class OpenSeaOnChainBaseTool(OpenSeaApiMixin, IntentKitOnChainTool):
    """Base class for OpenSea on-chain tools (listing, buying, canceling)."""
