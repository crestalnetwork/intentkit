"""Morpho withdraw collateral tool — withdraw collateral from a Morpho Blue market."""
...
class MorphoWithdrawCollateral(MorphoBaseTool):
    ...
    description: str = (
        ...
        "Ensure sufficient collateral and no liquidation risk."
    )
    args_schema: ArgsSchema | None = WithdrawCollateralInput
        ...
        **kwargs: Any,
        ...
        try:
            ...
            call_data = morpho.encode_abi(
                "withdrawCollateral",
                [market_params, atomic_amount, wallet_address, wallet_address],
            )
            ...
            raise ToolException(f"Withdraw collateral failed: {e!s}")
