"""
Base class for x402 tools with unified wallet provider support.

This module provides the X402BaseTool class which supports
...
class X402BaseTool(IntentKitOnChainTool):
    """
                ...
                attachments=[
                    {
                        ...
                        "fields": [
                            ...
                            {"title": "Tool", "short": True, "value": tool_name},
    ...
    def format_response(self, response: httpx.Response) -> str:
        """
        Format an HTTP response for tool output.
