"""Base class for Polymarket prediction market tools."""
...
class PolymarketBaseTool(IntentKitOnChainTool):
    """Base class for Polymarket tools.

    Inherits IntentKitOnChainTool for unified wallet signing support.
