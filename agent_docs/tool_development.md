...
### 5. Catalog Schema (`schema.json`)

Add a `schema.json` catalog file describing the category and its tools:
...
```json
{
  ...
  "description": "...",
  "x-tags": ["..."],
  "x-icon": "/tools/my_category/icon.png",
  "tools": {
    "my_category_tool_name": {"title": "...", "description": "..."}
  }
}
```
...
├── schema.json                 # Tool catalog (auto-generated by sync script)
